...
st.title("📊 Coupang 经营分析看板 (最终版·独立序号)")
        ...
        try:
            with st.spinner("正在全速计算中..."):
                ...
                if filter_profit == "只看盈利 (>0)":
                    ...
                    # df_sheet3 (SKU维度) 和 df_final_clean 行数对应
